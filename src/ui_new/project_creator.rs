...
impl UiProjectCreator {
    ...
    fn create_or_cancel(&mut self, ctx: &mut EFrameContext, ui: &mut Ui, created_or_cancelled: &mut bool) {
        ui.horizontal(|ui| {
    ...
    fn handle_project_creation(&mut self, ctx: &mut EFrameContext, created_or_cancelled: &mut bool) {
